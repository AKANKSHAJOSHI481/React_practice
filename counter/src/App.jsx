...
function App() {
  ...
  return (
    <div className="flex justify-center items-center bg-[#344151] gap-4 flex-col w-[100vw] h-[100vh]">
    <div className="text-[#0398d4] font-medium text-2xl">Increment and decrement</div>
    <div className="text-center flex bg-white gap-12 py-3 rounded-sm  text-[25px] text-[#344151]">
